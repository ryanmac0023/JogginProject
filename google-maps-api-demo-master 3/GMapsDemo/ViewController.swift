...
class ViewController: UIViewController, CLLocationManagerDelegate, GMSMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let camera: GMSCameraPosition = GMSCameraPosition.cameraWithLatitude(41.653909, longitude: -91.525435, zoom: 16.0)
    ...
    func configureMapAndMarkersForRoute() {
        viewMap.camera = GMSCameraPosition.cameraWithTarget(mapTasks.originCoordinate, zoom: 16.0)
